            ...
            <div class="row">
                <div class="with-region-personal col-sm-12">
                    <div class="row region-personal">
                        <div class="col-sm-8 info-trabajador">
                            <div class="row">
                        ...
                        <div class="col-sm-4 foto-trabajador">
                            <img src="../storage/img/usuario.png" alt="foto-trabajador" style="max-width:100%;">
                        </div>
